...
public class RoundOneBiddingTests extends BaseTest {
	...
	public void VerifyBiddingRound1NAFED() throws IOException {
		
		ExtentManager.initReport();
	    ExtentManager.createTest("Round 1 Bidding Test");
		...
		Object[][] biddata = ExcelUtil.getTestData("BidDetailsData.xlsx.xlsx", "BidData");
		...
		for (int i = 0; i < 3; i++) {
			...
			ExcelUtil.writeData("BidDetailsData.xlsx.xlsx", "BidData", i + 1, 3, freepoolBalanceBeforeBid); // second
																											// row
																											// third
																											// column
			System.out.println(
			...
			ExcelUtil.writeData("BidDetailsData.xlsx.xlsx", "BidData", i + 1, 4, blockpoolBalanceBeforeBid); // second
																												// row
																												// fourth
																												// column
			System.out.println(
			...
			double CalculatedEmdValue = Double.parseDouble(EmdData[0][9].toString()); // second row, ninth column
			ExcelUtil.writeData("BidDetailsData.xlsx.xlsx", "BidData", i + 1, 7, CalculatedEmdValue);
			System.out.println(
