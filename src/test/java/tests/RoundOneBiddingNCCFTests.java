...
public class RoundOneBiddingNCCFTests extends BaseTest{
	
	@Test(description = "Verify Bidder can Bid in Auction Round 1 NCCF")
	public void VerifyBiddingRound1NCCF() throws IOException {
		
		ExtentManager.initReport();
	    ExtentManager.createTest("Round 1 Bidding NCCF Test");
		...
		for (int i = 0; i < 3; i++) {
			...
			ExcelUtil.writeData("EMD_Workbook.xlsx", "EMDCalculation", 2, 0, BidPrice);
			...
			ExcelUtil.writeData("EMD_Workbook.xlsx", "EMDCalculation",  2, 1, BidQuantity);
