...
public class RoundOneBiddingGUJRATTests extends BaseTest {
	...
	public void VerifyBiddingRound1NCCF() throws IOException {
		...
		Object[][] biddata = ExcelUtil.getTestData("BidDetailsDataGUJRAT.xlsx", "BidData");
		...
		for (int i = 0; i < 3; i++) {
			...
			ExcelUtil.writeData("BidDetailsDataGUJRAT.xlsx", "BidData", i + 1, 3, freepoolBalanceBeforeBid); // second
																												// row
																												// third
																												// column
			System.out.println(
			...
			ExcelUtil.writeData("BidDetailsDataGUJRAT.xlsx", "BidData", i + 1, 4, blockpoolBalanceBeforeBid); // second
																												// row
																												// fourth
																												// column
			System.out.println(
			...
			double CalculatedEmdValue = Double.parseDouble(EmdData[1][5].toString()); // second row, ninth column
